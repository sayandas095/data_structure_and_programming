...
int infix_to_postfix(stack *s, char *math_expression)
{
	...
	for(i = 0; i<strlen(math_expression); i++)
	{
		...
		{
			if ((i + 1) == strlen(math_expression) || math_expression[i + 1] == '+' || math_expression[i + 1] == '-' || math_expression[i + 1] == '*' || math_expression[i + 1] == '/' || math_expression[i + 1] == '^' )
			{
				printf("\nInvalid expression\n");
				exit(1);
				return -1;
		...
		else if(math_expression[i] == ')')
		{
			...
			else if (((i + 1) != strlen(math_expression)) && (math_expression[i + 1] != '+' && math_expression[i + 1] != '-' && math_expression[i + 1] != '*' && math_expression[i + 1] != '/' && math_expression[i + 1] != '^' && math_expression[i + 1] != ')'))
			{
				printf("\nInvalid expression\n");
				exit(1);
				return -1;
		...
		else if (math_expression[i] == '+' || math_expression[i] == '-' || math_expression[i] == '*' || math_expression[i] == '/' || math_expression[i] == '^')
		{
			...
			if (!((int)(math_expression[i+1] >= 0 && (int)math_expression[i+1] <= 99) || math_expression[i + 1] == '('))
			{
				printf("\nInvalid expression\n");
				exit(1);
				return -1;
		...
		{
			if (((i + 1) != strlen(math_expression)) && (math_expression[i + 1] != '+' && math_expression[i + 1] != '-' && math_expression[i + 1] != '*' && math_expression[i + 1] != '/' && math_expression[i + 1] != '^' && math_expression[i + 1] != ')'))
			{
				printf("\nInvalid expression\n");
				exit(1);
				return -1;
